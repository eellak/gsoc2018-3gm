...
@NgModule({
  ...
  declarations: [StatuteComponent, StatuteArticlesComponent, StatuteCodifiedComponent,  StatuteHistoryComponent, StatuteDiffComponent ,  StatuteTimelineComponent, StatuteReferencesComponent]
})
