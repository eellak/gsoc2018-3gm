...
@NgModule({
  ...
  declarations: [StatuteComponent, StatuteArticlesComponent, StatuteCodifiedComponent,  StatuteHistoryComponent, StatuteDiffComponent ,  StatuteTimelineComponent, StatuteTopicsComponent , StatuteReferencesComponent, TopicComponent]
})
