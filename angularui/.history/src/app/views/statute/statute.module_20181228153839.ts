...
@NgModule({
  ...
  declarations: [StatuteComponent, StatuteDetailsComponent, StatuteHistoryComponent, StatuteDiffComponent ,  StatuteTimelineComponent, StatuteReferencesComponent]
})
