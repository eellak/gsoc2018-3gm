...
@Component({
  selector: 'app-statute-articles',
  templateUrl: './statute-articles.component.html',
  styleUrls: ['./statute-articles.component.scss'],
  animations: egretAnimations,
  providers: [StatuteService]
})
export class StatuteArticlesComponent implements OnInit, OnDestroy {
  isMobile;
...
getLaw() {
  ...
  this.getLawSub =  this.statuteService.getStatuteArticles(this.statuteID)
  .pipe(
    finalize(() =>  {
    this.loader.close();
  })
...
getArticle(articleID: string) {
  this.getArticleSub =  this.statuteService.getStatuteArticles(this.statuteID, articleID)
  .subscribe(article => {
