...
export class DashboardComponent implements OnInit , OnDestroy {
  ...
  tourSteps(): any {
    ...
    return {
      ...
      steps: [
        {
          title: 'Αναζήτηση νομοθετημάτων',
          content: 'Γράψτε έναν όρο αναζήτησης , τα δεδομένα φιλτράρονται αυτόματα. Επιλέξτε το νομοθέτημα για να δείτε την κωδικοποιημένη μορφή του',
          target: 'tourSearchBox', // Element ID
          placement: 'right',
          xOffset: 10
        },
        {
          title: 'Δημοφιλή Νομοθετήματα',
          content: 'Προβάλλονται τα πιο δημοφιλή νομοθετήματα.',
          target: 'tourTopLaws',
          placement: 'left',
          xOffset: 0,
          yOffset: -10
        ...
        {
          title: 'Πρόσφατα Νομοθετήματα',
          content: 'Επιλέξτε για να δείτε τα πιο πρόσφατα νομοθετήματα.',
          target: 'tourRecentLaws', // Element ID
          placement: 'left',
          xOffset: 15,
          yOffset: -10
        }
