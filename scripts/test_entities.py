...
courts = ['Ειρηνοδικείο', 'Μονομελές Πρωτοδικείο', 'Πολυμελές Πρωτοδικείο', 'Εφετείο', 'Άρειος Πάγος', 'Πταισματοδικείο', 'Μονομελές Πλημμελειοδικείο', 'Τριμελές Πλημμελειοδικείο', 'Δικαστήριο Ανηλίκων', 'Μικτό Ορκωτό Δικαστήριο', 'Τριμελές Εφετείο', 'Πενταμελές Εφετείο',
          'Μικτό Ορκωτό Εφετείο', 'Εισαγγελία Αρείου Πάγου', 'Εισαγγελία Εφετών', 'Εισαγγελία Πρωτοδικών', 'Μονομελές Διοικητικό Πρωτοδικείο', 'Τριμελές Διοικητικό Πρωτοδικείο', 'Διοικητικό Εφετείο', 'Συμβούλιο της Επικρατείας', 'Ελεγκτικό Συνέδριο', 'Στρατοδικείο', 'Ναυτοδικείο', 'Αεροδικείο']
