...
def fix_par_abbrev(s):
    q = {
        r'(η|Η) (παρ.|παρ)': 'η παράγραφος',
        r'(της|Της) (παρ.|παρ)': 'της παραγράφου',
        r'(την|Την) (παρ.|παρ)': 'την παράγραφο',
        r'(οι|Οι) (παρ.|παρ)': 'οι παράγραφοι',
        r'(των|Των) (παρ.|παρ)': 'των παραγράφων',
        r'(τις|Τις) (παρ.|παρ)': 'τις παραγράφους'
    }
